...
const registerValidations = [
  body("email")
    ...
    .withMessage("Ese email ya tiene una cuenta."),
  body("password")
    .isStrongPassword({
      minLength: 6,
      minLowercase: 1,
    ...
    .withMessage("La contraseña debe tener por lo menos 6 caracteres. Contar con 1 mayúscula, 1 minúscula, 1 número y 1 símbolo.")
    .bail()
